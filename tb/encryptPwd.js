    ...
    0 > c
      ...
      : ((o = !1),
        0 == u
          ? (this[this.t++] = c)
          : u + r > this.DB
            ? ((this[this.t - 1] |= (c & ((1 << (this.DB - u)) - 1)) << u),
  ...
  if (u-- > 0)
    for (
      ...
      n > s
        ...
        : ((e = (this[u] >> (s -= n)) & r), 0 >= s && ((s += this.DB), --u)),
        e > 0 && (i = !0),
        i && (o += c(e))
  return i ? o : '0'
}
...
function j(t) {
  ...
  for (e = 0; e < n.t - 1; ++e) {
    ...
    ;(t[e + n.t] += n.am(e + 1, 2 * n[e], t, 2 * e + 1, r, n.t - e - 1)) >=
...
function T(t, n, i) {
  ...
  if (!(o.t <= 0)) {
    ...
    var c = r(),
      ...
      a = t.s,
      f = this.DB - m(o[o.t - 1])
    f > 0 ? (o.lShiftTo(f, c), u.lShiftTo(f, i)) : (o.copyTo(c), u.copyTo(i))
    var l = c.t,
      h = c[l - 1]
    if (0 != h) {
      ...
      for (; --b >= 0; ) {
        var w =
          i[--g] == h ? this.DM : Math.floor(i[g] * v + (i[g - 1] + y) * d)
        if ((i[g] += c.am(0, w, i, b, 0, l)) < w)
          for (c.dlShiftTo(b, x), i.subTo(x, i); i[g] < --w; ) i.subTo(x, i)
      }
...
function Y() {
  if (null == vt) {
    for (J(), vt = X(), vt.init(dt), yt = 0; yt < dt.length; ++yt) dt[yt] = 0
    yt = 0
  }
  return vt.next()
}
...
if (null == dt) {
  ...
  for (getRandomValues(bt), mt = 0; 32 > mt; ++mt) dt[yt++] = bt[mt]
  // }
  // if (
